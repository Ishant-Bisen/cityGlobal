...
export default function Editaccountdetail() {
  ...
  async function kycupdate(e) {
    ...
    fetch("https://nidhibackend.onrender.com/user/updateKYC", {
      method: "PUT",
      headers: {
      ...
      body: JSON.stringify({
        ...
        AccHolderName: localStorage.getItem("user-name"),
        Aadhar: aadhar,
        PAN: pancard,
        MobileNo: number,
      }),
            ...
            <div class="content-wrapper">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                  <span class="text-muted fw-light">KYC</span>
                </h4>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                      <li class="nav-item">
                        <Link class="nav-link" to="/KYC">
                          <i class="bx bx-user me-1"></i>
                          KYC Details
                        </Link>
                      </li>
                      <li class="nav-item">
                        <Link class="nav-link active" to="/KYCUpdate">
