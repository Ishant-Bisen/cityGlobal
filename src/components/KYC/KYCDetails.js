...
export default function KYCDetails() {
  ...
  useEffect(() => {
    try {
      ...
      fetch("https://nidhibackend.onrender.com/user/getKycDetails", {
        method: "POST",
        headers: {
            ...
            <div class="content-wrapper">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                  <span class="text-muted fw-light">KYC Settings /</span>
                  KYC
                </h4>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                      ...
                      <li class="nav-item">
                        <Link class="nav-link" to="/KYCUpdate">
                        ...
                        >
                          <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              <h5>{localStorage.getItem("user-email")!= null ? localStorage.getItem("user-email") : <h3>N/A</h3>}</h5>
                            </div>
                            <div class="mb-3 col-md-6">
                              <label class="form-label" for="phoneNumber">
                                Mobile Number
                              </label>
                              <h5>{details.MobileNo != null ? details.MobileNo : <h3>N/A</h3>}</h5>
                            </div>
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              <h5 placeholder="1234-4444-1234-5555">
                                {details.Aadhar}
                              </h5>
                            </div>
                            <div class="mb-3 col-md-6">
                              ...
                              <h5 placeholder="DTUER0000F">{details.PAN}</h5>
                            </div>
                          </div>
                        </form>
                      </div>
