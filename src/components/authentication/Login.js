...
export default function Login() {
    ...
    async function login(e){
        ...
        fetch('https://nidhibackend.onrender.com/authenticate/login', {
            method: 'POST',
            headers: {
                    ...
                    <div className="authentication-inner">
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                {/* <!-- /Logo --> */}
                                <h4 className="mb-2">Log into your Account 👋</h4>
                                ...
                                <form action="admin-dashboard.html" id="formAuthentication" className="mb-3">
                                    ...
                                    <div className="mb-3 form-password-toggle">
                                        ...
                                        <div className="input-group input-group-merge">
                                            <input
                                                ...
                                                className="form-control"
                                                name="password"
                                                // onchange fire a event and passing event target value in setpassword
                                    ...
                                    <div className="mb-3">
                                        {/* on click passing a event in the function and calling a login function passing that event */}
                                        <button className="btn btn-primary d-grid w-100" type="submit" onClick={(e) => login(e)}>
                                            Sign in
                                        </button>
                                    </div>
                                </form>
