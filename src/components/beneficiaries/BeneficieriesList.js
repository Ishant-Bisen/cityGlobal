...
export default function BeneficieriesList() {
  ...
  useEffect(() => {
    try {
      fetch("https://nidhibackend.onrender.com/user/getBeneficiaries", {
        method: "POST",
        headers: {
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <Link class="nav-link active" to="/benelist">
                        <i class="bx bx-user me-1"></i>Beneficiaries List
                      </Link>
                    </li>
                    <li class="nav-item">
                      <Link class="nav-link" to="/adbene">
                        <i class="bx bx-bell me-1"></i>Add Beneficiary
                      </Link>
                    </li>
                  </ul>
                  <h5 class="card-header">Beneficiaries-List</h5>
                ...
                {/* <!--/ Contextual Classes --> */}
                <hr class="my-5" /> {/* <!--/ Responsive Table --> */}
              </div>
              {/* <!-- / Content --> */}
