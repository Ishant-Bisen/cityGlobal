...
export default function Editaccountdetail() {
   ...
   const handellogout = () => {
    ...
    async function addDetails(e){
        ...
        e.preventDefault()
        console.log(  email  ,name , number , accnumber , zipcode , state , adress , actype , ifsc , bank ,branch , localStorage.getItem("userid") ,localStorage.getItem("user-auth-token"));
        fetch('https://nidhibackend.onrender.com/user/updateBankDetails', {
            method: 'PUT',
            headers: {
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                            <li class="nav-item">
                                                <Link class="nav-link" to="/userdetail">
                                                ...
                                                <form id="formAccountSettings" method="POST" onsubmit="return false">
                                                    <div class="row">
                                                        <div class="mb-3 col-md-6">
                                                            <label for="firstName" class="form-label">Account Holder’s Name</label >
                                                            <input
                                                                class="form-control"
                                                                type="text"
                                                                id="firstName"
                                                    ...
                                                    <div class="mt-2">
                                                        <button type="submit" class="btn btn-primary me-2" onClick={(e) => addDetails(e)}>
                                                            Save changes
                                                        </button>
